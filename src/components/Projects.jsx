      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 gap-4">
          {projectsData.map((project) => (
            <motion.div key={project.id} className="rounded-2xl p-8 lg:p-12 border border-gray-200 relative overflow-hidden" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              ...
              <div className="flex flex-col sm:flex-row gap-8 items-stretch">
                <div className="flex flex-col">
                  ...
                  <button
                    ...
                    className="bg-lime-accent text-black px-8 py-3 rounded-lg font-semibold hover:bg-[#8FE000] transition-all duration-300"
                ...
                <img className="w-1/2 h-[calc(100vh-18rem)] object-cover rounded-2xl" src={project.image} alt="image" />
              </div>
            </motion.div>
          ))}
        </div>
